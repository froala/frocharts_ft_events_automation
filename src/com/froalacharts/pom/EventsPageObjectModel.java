...
//		legend.click();
	...
	public void canvasZoomIn() throws AWTException
	{
		...
		//Zoom into Chart element
		WebElement canvas_zoom = driver.findElement(By.xpath("(//*[@class=\"raphael-group-73-column-plot-meso\"]//*)[2]"));
		Point point = canvas_zoom.getLocation();
