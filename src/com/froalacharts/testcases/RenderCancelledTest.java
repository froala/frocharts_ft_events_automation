...
import com.froalacharts.events.RenderCancelled;
...
public class RenderCancelledTest extends EventsTestBase {

	//The api name according to the data sheet
	private final static String eventTestName = "renderCancelled"; 
	Object[][] data;
	...
	public void shutDown() 
	{
		try
		{
			System.out.println("renderCancelled executed");
			Thread.sleep(3000);
		}
