...
import com.froalacharts.events.ChartTypeInvalid;
...
public class ChartTypeInvalidTest extends EventsTestBase {

	//The api name according to the data sheet
	private final static String eventTestName = "charttypeinvalid"; 
	Object[][] data;
...
//		pom.ischartRendered();
	...
	public void chartTypeInvalid()
	{
		
		ChartTypeInvalid.charttypeinvalid();
	...
	public void shutDown() 
	{
		try
		{
			System.out.println("chartTypeInvalid executed");
			Thread.sleep(3000);
		}
