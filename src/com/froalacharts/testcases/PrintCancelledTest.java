...
import com.froalacharts.events.ExportCancelled;
...
public class PrintCancelledTest extends EventsTestBase {

	
	//The api name according to the data sheet
	private final static String eventTestName = "printCancelled"; 
	Object[][] data;
	...
	public void shutDown()
	{
		try
		{
			System.out.println("printCancelled executed");
			Thread.sleep(3000);
		}
