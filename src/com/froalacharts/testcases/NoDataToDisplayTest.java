...
public class NoDataToDisplayTest extends EventsTestBase {

	//The api name according to the data sheet
	private final static String eventTestName = "noDataToDisplay"; 
	Object[][] data;
...
//		pom.ischartRendered();
	...
	public void shutDown() 
	{
		try
		{
			System.out.println("noDataToDisplay executed");
			Thread.sleep(3000);
		}
