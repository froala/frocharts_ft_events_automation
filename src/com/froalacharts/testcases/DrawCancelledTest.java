...
public class DrawCancelledTest extends EventsTestBase {

	//The api name according to the data sheet
	private final static String eventTestName = "drawcancelled"; 
	Object[][] data;
...
//		pom.ischartRendered();
	...
	public void shutDown() 
	{
		try
		{
			System.out.println("drawcancelled executed");
			Thread.sleep(3000);
		}
