...
public class ResizeCancelledTest extends EventsTestBase  {

	
	//The api name according to the data sheet
	private final static String eventTestName = "resizeCancelled"; 
	Object[][] data;
	...
	{
		js.executeScript("tsChart.resizeTo(500,600)");
	...
	public void shutDown()
	{
		try
		{
			System.out.println("resizeCancelled executed");
			Thread.sleep(3000);
		}
