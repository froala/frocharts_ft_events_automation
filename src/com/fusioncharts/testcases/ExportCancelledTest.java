...
public class ExportCancelledTest extends EventsTestBase {
	
	//The api name according to the data sheet
	private final static String eventTestName = "exportCancelled"; 
	Object[][] data;
	...
	public void shutDown()
	{
		try
		{
			System.out.println("exportCancelled executed");
			Thread.sleep(3000);
		}
